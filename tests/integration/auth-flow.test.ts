 ...
 * PostgreSQL, not mocks (PRD §9.1, api_specification.md §3).
 *
...
d('Refresh rotation and reuse detection', () => {
...
d('Protected routes (deny by default)', () => {
...
d('Rate limiting (PRD §9.1 resource abuse)', () => {
  it(
