...
> **This document is the handshake.** The API implements exactly this; clients consume exactly this. A changed contract is a version bump on this file shipped in the same PR as the code. Never implement an undocumented endpoint.
>
...
## 14. Collaboration & Activation *(Release 2–3)*
...
This document is versioned. A change to any contract here is a version bump,
a migration or client update where needed, and a PR that updates this file in
the same commit as the code. Never implement an undocumented endpoint.
