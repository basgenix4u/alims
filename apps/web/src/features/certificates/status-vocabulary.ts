 ...
 *
 * Source: docs/design/ui-ux-specification.md §7 (status & verification badge system),
...
/**
 * Tone → CSS custom properties from the design token system
 * (`apps/web/src/styles/tokens.css`).
 *
 * Components consume tokens, never hex literals (design spec §3.6 rule 1).
 * The fallback values below mirror the WCAG-verified colours from spec §3.3
 * and are confined to this one function; the tokens take precedence wherever
 * they are defined.
 */
