...
export const en = {
  ...
  members: {
    ...
    addHelp: 'The person must already have an ALIMS account. They can register from the sign-up page.',
    email: 'Email',
    role: 'Role',
    status: 'Status',
    ...
    revoke: 'Revoke',
    revoked: 'Membership revoked. The row and its history are kept.',
    confirmRevoke: 'Revoke this membership? The person loses institution access; history is kept.',
    selfGuard: 'You cannot change your own membership here.',
    bulkTitle: 'Bulk invite',
    bulkHelp: 'One email per line, up to 500. Invited members are activated with the chosen role.',
    bulkRole: 'Role for invitees',
    bulkGo: 'Invite',
    bulkResult: 'Results',
    noAccount: 'No ALIMS account for this email yet.',
    alreadyMember: 'Already an active member.',
    invited: 'Invited and activated.',
  },
  ...
  review: {
    ...
    similarityTitle: 'Similarity assessment',
    similarityStatus: 'Assessment status',
    similarityScore: 'Overlap score',
    similarityProvider: 'Provider',
    similarityUnavailable: 'Similarity data is not available for this version.',
    similarityOutcome: 'Integrity outcome',
    similarityReason: 'Reason',
    similarityReasonHelp: 'Plain language; part of the attributable record. At least 10 characters.',
    similaritySubmit: 'Record integrity review',
    similaritySubmitted: 'Integrity review recorded. This is a review signal only.',
